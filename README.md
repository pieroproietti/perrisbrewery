...
running command...
$ pb (--version|-v)
perrisbrewery/9.3.11-1 linux-x64 node-v16.18.1
$ pb --help [COMMAND]
USAGE
  $ pb COMMAND
...
...
_See code: [lib/commands/deb.js](https://github.com/pieroproietti/perrisbrewery/blob/v9.3.11-1/lib/commands/deb.js)_
